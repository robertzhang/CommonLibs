package com.robertzhang.commonlibs.progress;
...
public class CircularProgressBar extends ProgressBar {
  ...
  public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (isInEditMode()) {
      setIndeterminateDrawable(new com.robertzhang.commonlibs.progress.CircularProgressDrawable.Builder(context, true).build());
      return;
    }
    ...
    com.robertzhang.commonlibs.progress.CircularProgressDrawable.Builder builder = new com.robertzhang.commonlibs.progress.CircularProgressDrawable.Builder(context)
  ...
  private com.robertzhang.commonlibs.progress.CircularProgressDrawable checkIndeterminateDrawable() {
     Drawable ret = getIndeterminateDrawable();
     if (ret == null || !(ret instanceof com.robertzhang.commonlibs.progress.CircularProgressDrawable))
        throw new RuntimeException("The drawable is not a CircularProgressDrawable");
     return (com.robertzhang.commonlibs.progress.CircularProgressDrawable) ret;
  }
  ...
  public void progressiveStop(com.robertzhang.commonlibs.progress.CircularProgressDrawable.OnEndListener listener) {
