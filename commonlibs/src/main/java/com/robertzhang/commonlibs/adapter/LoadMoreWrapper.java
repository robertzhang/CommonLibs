...
public class LoadMoreWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private com.robertzhang.commonlibs.adapter.LoadMoreScrollListener mLoadMoreScrollListener;
    ...
    public LoadMoreWrapper(Context context, RecyclerView.Adapter adapter) {
        ...
        mLoadMoreScrollListener = new com.robertzhang.commonlibs.adapter.LoadMoreScrollListener() {
            @Override
    ...
    private ViewHolder getLoadMoreViewHolder() {
        ...
        return com.robertzhang.commonlibs.adapter.ViewHolder.createViewHolder(mContext, mLoadMoreView);
    }
    ...
    private ViewHolder getLoadFailedViewHolder() {
        ...
        return com.robertzhang.commonlibs.adapter.ViewHolder.createViewHolder(mContext, mLoadMoreFailedView);
    }
    ...
    private ViewHolder getNoMoreViewHolder() {
        ...
        return com.robertzhang.commonlibs.adapter.ViewHolder.createViewHolder(mContext, mNoMoreView);
    }
    //endregion
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        com.robertzhang.commonlibs.adapter.WrapperUtils.onAttachedToRecyclerView(mInnerAdapter, recyclerView, new com.robertzhang.commonlibs.adapter.WrapperUtils.SpanSizeCallback() {
            @Override
