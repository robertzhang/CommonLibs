...
import com.robertzhang.commonlibs.utils.SharePreferenceUtils;
...
public class SettingCenter {
    ...
    public static boolean getOnlyWifiLoadImage() {
        return SharePreferenceUtils.getBoolean(BaseApplication.getInstance(), "getOnlyWifiLoadImage", false);
    }

    public static void setOnlyWifiLoadImage(boolean isEnable) {
        SharePreferenceUtils.putBoolean(BaseApplication.getInstance(), "getOnlyWifiLoadImage", isEnable);
    }
